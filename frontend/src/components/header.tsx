  ...
  return (
    <>
      ...
      <div className="flex justify-between mb-0">
        ...
        <button className="p-2 rounded-full hover:bg-[#0d3036] transition-colors absolute top-[2.5%] left-[71%]" aria-label="Избранное">
          <img src="/Group_765.png" className="w-6 h-6 w-[39px] h-[39px]" alt="Dashboard" />
        </button>
      </div>
