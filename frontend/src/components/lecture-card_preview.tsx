    ...
    <Card className="relative overflow-hidden border-0 bg-black/0 text-white w-full rounded-none h-[26.5vh] shadow-none">
      ...
      <CardFooter className="flex items-center justify-end relative z-10">
        <div className="flex items-center gap-3">
          <span className="text-[15px] font-[400] leading-[18.15px] tracking-[1px] absolute left-[15%] top-[7.5vh]">{price}</span>
          <Button className="rounded-full w-[109px] h-[44px] absolute top-[8vh] left-[62vw] gap-[10px] pt-[13px] pr-[28px] pb-[13px] pl-[28px] bg-[rgba(10,114,74,1)] hover:bg-emerald-700 shadow-[inset_0px_1px_1px_0px_rgba(36,186,128,1)] text-[15px]">
            Купить
          </Button>
